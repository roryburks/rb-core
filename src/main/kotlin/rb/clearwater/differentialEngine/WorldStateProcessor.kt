...
interface IWorldStateProcessor {
    fun tick(
        ...
        animationAccess: IAnimationLoadingSystem) : WorldState
    ...
    : IWorldStateProcessor
{
    override fun tick(
        ws: WorldState,
        input: IGameInputAccess,
        animationAccess: IAnimationLoadingSystem
    ): WorldState
    {
        ...
        val access = Access(ws, animationAccess, actorAccess)
    ...
    override fun onInit(ws: WorldState, animationAccess: IAnimationLoadingSystem): WorldState {
        val hitboxSet = HitboxObjectSet()
    ...
    private inner class Access(
        val ws: WorldState,
        override val animationAccess: IAnimationLoadingSystem,
